...
exports.seed = async function(knex) {
  ...
  await knex('items').insert([
    ...
    {id: 4, userid: 1, itemname: 'testitem4', description: 'This is a test description for an item that does not exist', quantity: 106},
    {id: 5, userid: 1, itemname: 'testitem5', description: 'This is a test description for an item that also does not exist', quantity: 45},
    ...
    {id: 7, userid: 2, itemname: 'testitem7', description: 'This is a test description for an item that does not exist', quantity: 7},
    {id: 8, userid: 3, itemname: 'testitem8', description: 'This is a test description for an item that also does not exist', quantity: 34},
